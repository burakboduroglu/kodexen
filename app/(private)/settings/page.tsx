...
import { AlertCircle, Bookmark, Gift, KeyRound, Lock, Settings, Shield, Smartphone, User } from "lucide-react"
    ...
    <div className="container max-w-4xl pt-8 pb-4 px-4">
      ...
      <Tabs defaultValue="profile" className="space-y-4">
        <TabsList className="w-full border-b rounded-none bg-transparent p-0 h-auto">
          <TabsTrigger value="profile" className="flex items-center gap-2 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent">
            <User size={16} />
            Profil
          </TabsTrigger>
          <TabsTrigger value="security" className="flex items-center gap-2 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent">
            <Lock size={16} />
            Güvenlik
          </TabsTrigger>
          <TabsTrigger value="bookmarks" className="flex items-center gap-2 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent">
            <Bookmark size={16} />
            Kaydedilenler
          </TabsTrigger>
          <TabsTrigger value="premium" className="flex items-center gap-2 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent">
            <Gift size={16} />
            Premium
          </TabsTrigger>
          <TabsTrigger value="preferences" className="flex items-center gap-2 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent">
            <Settings size={16} />
            Tercihler
          </TabsTrigger>
        </TabsList>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-yellow-500/10 text-yellow-500 text-xs font-medium px-2 py-1 rounded-full">Yakında</span>
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between space-x-2">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Video içerikleri otomatik oynat
                  </p>
                </div>
                <Switch />
              </div>
