...
async function getPost(id: string): Promise<Post | null> {
  const dummyPost: Post = {
    id: id,
    content: "TypeScript ile geliştirdiğim yeni projemin kaynak kodlarını GitHub'da paylaştım! Göz atmak isteyenler için link yorumlarda 🚀 #typescript #opensource",
    author: {
      id: 'user123',
  ...
  if (!post) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px]">
        ...
        <p className="text-muted-foreground mt-2">This post might have been deleted or is no longer available.</p>
