...
export default function UserInfo() {
  return (
    <div className='container max-w-4xl'>
      <div className='sticky top-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 z-10 py-6'>
        <div className='mb-8'>
              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <textarea
                      id='bio'
                      className='w-full min-h-[px] rounded-md border border-input bg-background px-3 py-2'
                      placeholder='Kendinizden bahsedin...'
                    />
                  </div>
                  <Button disabled={true}>
                    {true ? 'Kaydediliyor...' : 'Değişiklikleri Kaydet'}
                  </Button>
                </CardContent>
              </Card>
            </TabsContent>
